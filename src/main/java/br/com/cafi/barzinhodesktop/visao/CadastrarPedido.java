...
public class CadastrarPedido extends javax.swing.JPanel {
    ...
    /**
     * Creates new form CPedido
     */
    public CadastrarPedido(JInternalFrame jif, Comanda comanda, Pedido pedido) {
        initComponents();
        this.jif = jif;
        ...
        this.mesaLabel.setText("Mesa " + comanda.getNome());
    }

    public CadastrarPedido(JInternalFrame jif, Pedido pedido) {
        initComponents();
        this.jif = jif;
        this.pedido = pedido;
        carregarTabela();
        carregarTabelaItemPedido();
        totalTextField.setText(pedido.getObservacao());
        this.mesaLabel.setText("Delivery");
    }
    ...
    private void carregarTabelaItemPedido() {
        ...
        listaItemPedido = bo.findWhere(getPedido().getId());
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(produtoTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(qntTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 129, Short.MAX_VALUE)))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(trocoTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 121, Short.MAX_VALUE)
    ...
    private void qntTextFieldKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_qntTextFieldKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (getProdutoSelecinado() != null && !"0".equals(qntTextField.getText())) {
                ...
                if ("".equals(totalTextField.getText())) {
                    totalTextField.setText(ip.getPreco() + "");

                } else {
                    totalTextField.setText(((Float.parseFloat(totalTextField.getText())) + ip.getPreco()) + "");
        ...
        getPedido().setObservacao(totalTextField.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (opcao == JOptionPane.YES_OPTION) {
            ...
            pedido.setObservacao((Float.parseFloat(pedido.getObservacao()) - ip.getPreco()) + "");
            PedidoBO pbo = new PedidoBO();
            pbo.update(getPedido());
            bo.delete(ip);
    ...
    private void pagamentoTextFieldKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pagamentoTextFieldKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (!"0".equals(pagamentoTextField.getText())) {
               trocoTextField.setText((Float.parseFloat(pagamentoTextField.getText())-Float.parseFloat(pedido.getObservacao()))+"");
            }
    ...
    private void carregarDados() {
        // clienteTextField.setText(pedido.getCliente() == null ? "sem cliente" : pedido.getCliente().getNome());
        //  descricaoTextField.setText(pedido.getObservacao());
        // mesaLabel.setText(pedido.getComanda() == null ? "delivery" : pedido.getComanda().getNome());
        // comanda = pedido.getComanda();
        // statusTextField.setText(pedido.getStatus());
        //totalTextField.setText(pedido.getTipo());
    }
    ...
    public void setjTextField1(javax.swing.JTextField jTextField1) {
        this.totalTextField = jTextField1;
    }
    ...
    public void setjTextField2(javax.swing.JTextField jTextField2) {
        this.pagamentoTextField = jTextField2;
    }
    ...
    public void setjTextField3(javax.swing.JTextField jTextField3) {
        this.trocoTextField = jTextField3;
    }

    /**
     * @return the mesaLabel
     */
    public javax.swing.JLabel getMesaLabel() {
        return mesaLabel;
    }

    /**
     * @param mesaLabel the mesaLabel to set
     */
    public void setMesaLabel(javax.swing.JLabel mesaLabel) {
        this.mesaLabel = mesaLabel;
    }
